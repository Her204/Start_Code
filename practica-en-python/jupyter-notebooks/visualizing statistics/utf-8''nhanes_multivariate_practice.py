...
plt.show()
print(da.loc[da.BPXDI1, ["BPXDI1", "BPXDI2"]].dropna().corr())
...
sns.FacetGrid(da, col="RIDRETH1",  row="RIAGENDRx").map(sns.scatterplot, "BPXDI1", "BPXDI2").add_legend()
...
a = sns.violinplot(x="DMDEDUC2x",y="RIDAGEYR",hue="RIAGENDRx",data=da, palette="muted")
...
da["DMDEDUC2x"] = da.DMDEDUC2.replace({1: "<9", 2: "9-11", 3: "HS/GED", 4: "Some college/AA", 5: "College", 
                                       7: "Refused", 9: "Don't know"})
needed = da[da["DMDEDUC2"] <= 5]
plt.figure(figsize=(12, 8))
a = sns.violinplot(x="DMDEDUC2x",y="RIDAGEYR",hue="RIAGENDRx",data=needed)
